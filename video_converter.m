...
folder = '/home/gregorlenz/Recordings/face-detection/indoor/alex/1';
outFolder = folder;
...
movieFullFileName = fullfile(folder, 'run1.mp4');
...
try
	...
	for frame = 1 : numberOfFrames
        ...
        filteredFrame = medfilt2(rgb2gray(thisFrame));
		...
		if writeToDisk
			...
			imwrite(filteredFrame, outputFullFileName, 'png');
		end
		...
		title('Median Filter', 'FontSize', fontSize);
...
%		return;
    ...
    outFilePath = [outFolder, '/', 'filtered.avi'];
	writerObj = VideoWriter(outFilePath);
